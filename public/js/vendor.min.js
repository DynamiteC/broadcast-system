...
! function () {
    "undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function () {
        ...
        Array.prototype.forEach && Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function (t) {
            ...
            l.className = "language-" + r, t.textContent = "", l.textContent = "Loadingâ€¦", t.appendChild(l);
            var i = new XMLHttpRequest;
            i.open("GET", a, !0), i.onreadystatechange = function () {
                4 == i.readyState && (i.status < 400 && i.responseText ? (l.textContent = i.responseText, Prism.highlightElement(l)) : l.textContent = i.status >= 400 ? "âœ– Error " + i.status + " while fetching file: " + i.statusText : "âœ– Error: File does not exist or is empty")
            }, i.send(null)
        })
